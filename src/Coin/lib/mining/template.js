...
class BlockTemplate {
  ...
  setBits(bits) {
    ...
    this.bits = bits;
    console.log("setbits at template 213")
    console.log(bits)
  ...
  getRawCoinbase(nonce1, nonce2) {
    console.log("get raw coinbase at template 371")
    let size = 0;
  ...
  getProof(nonce1, nonce2, time, nonce) {
    console.log("getproof at tempate 430")
  ...
  getCoinbase(nonce1, nonce2) {
    console.log("getcoinbase at template 445")
    const raw = this.getRawCoinbase(nonce1, nonce2);
  ...
  commit(proof) {
    console.log("commit at tempate 465")
    ...
    block.nonce = nonce;
    console.log("created block template 479")
